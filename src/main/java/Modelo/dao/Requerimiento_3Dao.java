...
public class Requerimiento_3Dao {
    ...
    public ArrayList<Requerimiento_3> requerimiento3()  throws SQLException {
        ...
        try{
            ...
            String consulta = "SELECT Compra.Proveedor, Compra.Pagado, Proyecto.Constructora  FROM Compra INNER JOIN  Proyecto ON Compra.ID_Proyecto = Proyecto.ID_Proyecto where (Pagado = 'No' AND Proveedor ='JUMBO')";
